...
package com.makezhao.zhihumoment.service;
...
import com.makezhao.zhihumoment.app.VolleySingleton;
...
public class CacheService extends Service {
        ...
        if (cursor.moveToFirst()) {
            do {
                if ((cursor.getInt(cursor.getColumnIndex("zhihu_id")) == id)
                    ...
                    StringRequest request = new StringRequest(Request.Method.GET, Api.ZHIHU_NEWS + id, new Response
                            .Listener<String>() {
                        @Override
                        public void onResponse(String s) {
                            ...
                            if (story.getType() == 1) {
                                StringRequest request = new StringRequest(Request.Method.GET, story.getShare_url(),
    ...
    private void deleteTimeoutPosts() {
        ...
        long timeStamp = (c.getTimeInMillis() / 1000) - Long.parseLong(sp.getString("time_of_saving_articles", "7"))
                * 24 * 60 * 60;
