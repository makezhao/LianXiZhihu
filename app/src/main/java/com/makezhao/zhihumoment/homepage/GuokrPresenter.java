...
package com.makezhao.zhihumoment.homepage;
...
import com.makezhao.zhihumoment.bean.StringModelImpl;
import com.makezhao.zhihumoment.db.DatabaseHelper;
import com.makezhao.zhihumoment.detail.DetailActivity;
import com.makezhao.zhihumoment.interfaze.OnStringListener;
import com.makezhao.zhihumoment.service.CacheService;
import com.makezhao.zhihumoment.util.Api;
import com.makezhao.zhihumoment.bean.BeanType;
import com.makezhao.zhihumoment.util.NetworkState;
    ...
    public void loadPosts() {
        ...
        if (NetworkState.networkConnected(context)) {
            ...
            if (cursor.moveToFirst()) {
                do {
                    GuokrHandpickNews.result result = gson.fromJson(cursor.getString(cursor.getColumnIndex
                            ("guokr_news")), GuokrHandpickNews.result.class);
                    list.add(result);
